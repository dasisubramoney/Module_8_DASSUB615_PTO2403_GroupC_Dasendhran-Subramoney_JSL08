...
class BankBranch {
    ...
    constructor(branchInfo){
        ...
        if (bankBranchInstance == null) {
            // If no instance exists, create one with the provided branchInfo
            this.branchInfo = branchInfo;
            bankBranchInstance = this; // Assign the new instance to the singleton variable
        }
        // Return the singleton instance whether newly created or existing
...
const branchA = new BankBranch({ name: "Branch A", address: "189 Beyers Naude Drive" });
const branchB = new BankBranch({ name: "Branch B", address: "1258 Jukskei Avenue Weltevreden Park" });
